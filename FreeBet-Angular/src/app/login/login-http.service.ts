...
export class LoginHttpService {
  ...
  constructor(private appConfig: AppConfigService, private adminService: AdminHttpService, private bettorServices: BettorHttpServices, private http: HttpClient) {
    this.load();
  }
